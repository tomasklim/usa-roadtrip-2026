...
export const CHECKS: CheckItem[] = [
  ...
  { id: 'flight-sea-slc', category: 'flights', block: true, t: 'Book SEA → SLC', d: 'Match the selected Seattle weather plan. Compare the complete price including checked bags, and leave time to return the Seattle rental before flying to Salt Lake City.' },
  { id: 'flight-slc-sfo', category: 'flights', block: true, t: 'Book SLC → SFO', d: 'Match the end of the active Salt Lake road trip. Compare the complete price including checked bags, and leave time to return the Tesla before flying to San Francisco.' },
  ...
  { id: 'tomales-20260924', category: 'experiences', t: 'Book The Boat at Hog Island', d: 'Choose the service that actually runs on your visit date. Only needed if you select the Point Reyes oyster module; confirm the current schedule and reservation availability for the resulting date.', url: 'https://hogislandoysters.com/' },
  { id: 'pumpkin-weighoff', category: 'experiences', t: 'Plan Half Moon Bay · Monday October 12', d: 'The weigh-off is fixed: weighing roughly 07:00–11:00 at IDES Grounds, 735 Main Street. Plan the early drive from Monterey and parking. Do not confuse it with the October 17–18 festival. Extra route modules may remove the coast day.', url: 'https://hmbweighoff.com/quick-facts.html' },
  { id: 'red-butte', category: 'experiences', t: 'Make time for Red Butte Garden', d: 'Use the early Salt Lake arrival afternoon if available; otherwise protect roughly 14:30–17:00 before the final rental return. October garden hours are 09:00–17:00. Check current admission and closures.', url: 'https://redbuttegarden.org/plan-your-garden-visit/general-info/' },
  { id: 'topaz-calendar', category: 'experiences', t: 'Check Topaz Farm for the Portland date', d: 'The farm is not Wednesday-only. Confirm opening and available crops for September 26 or 27; trade some shopping or walking time for the farm detour if you choose it.', url: 'https://topazfarm.com/' },

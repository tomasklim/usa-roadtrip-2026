...
export const CHECKS = [
  ...
  { id: "turo", block: true, t: "Get written permission for Bonneville and the other states", d: "Salt is corrosive and many listings ban leaving pavement. Confirm Bonneville access and out-of-state travel (WY, MT, ID) with the host. The charging plan assumes the US Tesla and no charging adapters." },
  ...
  { id: "sea-car-20260924", block: true, t: "Book the Seattle car from arrival on Sept 24", d: "Pick up after the 16:00 arrival; allow time for immigration, bags and the rental shuttle. Return Sunday evening for the Monday morning SLC flight, otherwise Monday (later with the Olympic extension). Compare exact times, fees and change terms." },
  { id: "hops-20260929", block: true, t: "Book SEA → SLC and SLC → SFO", d: "Use the selected first-five-days plan: clear weather defaults to Monday Sept 28 evening; rainy weather to Monday morning with a rest day in SLC. Monday Rainier requires Tuesday morning. Utah car pickup remains Sept 29, and SLC–SFO October 10 in the base route. Exact flights are not selected; recheck dates if adding modules." },
  ...
  { id: "gardiner-native-plug", block: true, t: "Verify the Gardiner charging connector before booking", d: "No adapter carried. Ask for a native Tesla/NACS plug and confirm guest access, availability and power; L2 alone is not enough. If unavailable, check the complete route between confirmed Tesla chargers before committing to the stay. Good-weather nights: Oct 4 and 6; bad-weather nights: Oct 4 and 5 in the base dates." },
  { id: "laurel-return", t: "Save Laurel Supercharger and check the full energy plan", d: "Fairfield by Marriott, 301 S Washington Ave, Laurel: 8 stalls, up to 250 kW, 24/7. Plan Gardiner → Beartooth → Red Lodge → Laurel, including overnight use, even if the optional Red Lodge Tesla destination chargers fail. In Laurel, charge for the onward Gardiner night and drive to Bozeman." },
  ...
  { id: "hama-20260925", t: "Reserve Hama Hama for Friday Sept 25", d: "The Oyster Saloon is open Friday–Sunday, 11:00–17:00. Reservations for that weekend open Monday Sept 21 at 09:00 Pacific; the table price includes two dozen oysters. Visit Olympia first, then aim for lunch around 11:30–12:00." },
  { id: "oyster-bay-20260925", t: "Check Oyster Bay Inn for Friday Sept 25", d: "Preferred hotel candidate in Bremerton, not booked. Compare the final room price and parking. The next day follows the selected weather plan: Portland, Hood Canal or Rainier." },

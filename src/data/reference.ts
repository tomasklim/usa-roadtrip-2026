...
export const SLEEP_CARDS = [
  ...
  { h: "Realistic mix for two", body: "The plan schedules <b>two free car nights</b> — Lolo National Forest and Bridger-Teton — where the setting genuinely justifies it, and a bed for the rest. Swap any motel night for a rest area if you want to save money; shoulder-season motels in Gardiner, West Yellowstone and Whitefish run $90–140, so suffering for its own sake makes no sense." }
];

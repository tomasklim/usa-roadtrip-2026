...
export const RISKS = [
  ...
  { h: "Yellowstone", body: "Most park roads are projected to stay open until <b>Oct 31</b>, weather permitting. Your base Yellowstone days are Oct 1–6. Construction at the Gardner River bridge can add delays, so check alerts as well as closures.", dl: "weather and roadworks can change daily" },
  { h: "Bonneville Salt Flats", body: "The base plan visits on <b>Sept 28</b>; check BLM event closures before going. Access and driving still depend on seasonal closures and dry salt. Never drive on wet salt, and get the rental host's written permission.", dl: "dry and signed open only" },
...
export const CHECKS = [
  { id: "dates-20260924", block: true, t: "Update the Turo booking to Sept 28 – Oct 9", d: "The quote runs Sept 27 → Oct 6. The updated base route needs Sept 28 → Oct 9 (12 calendar days). Move pickup and return to match, confirm the new price and mileage allowance, and use the active itinerary dates if adding modules." },
  ...
  { id: "sea-car-20260924", block: true, t: "Book the second car in Seattle, Sept 26–27", d: "Two days for Mount Rainier and Hood Canal. FSD is pointless over two days, so this can be an ordinary airport rental — pick on price. Same pickup and drop-off point." },
  ...
  { id: "hama-20260924", t: "Reserve Hama Hama for Sunday Sept 27", d: "The Oyster Saloon is open Friday–Sunday, 11:00–17:00. Reservations for the coming weekend open on Monday; the table deposit includes two dozen oysters." },
